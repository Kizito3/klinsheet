        ...
        <div class="container">
            <div class="hero-section">
                <div class="hero-heading">
                    <h2>The Most Dependable <br> Background check company <br>
                        in Nigeria
                    </h2>
                    <div class="hero-btn">
        ...
        <div class="container">
            <div class="partner">
                <div class="our-partners">
                    <h2>Our Partners</h2>
                    <p>In order to deliver value to our customers, we <br> have built strategic partnership with highly <br>effective companies for innovative & high-end <br>technological supports.</p>
                </div>
